...
class VariationalLogisticRegressor(BayesianLogisticRegressor):
    ...
    def fit(self, X, t, iter_max=1000):
        """
        variational bayesian estimation of the weight parameter w
        ...
        t : (sample_size,) ndarray
            corresponding binary target label either 0 or 1
